...
public class LogicManagerTest {
    ...
    @BeforeEach
    public void setUp() {
        JsonEduDexStorage eduDexStorage =
                new JsonEduDexStorage(temporaryFolder.resolve("eduDex.json"));
        JsonUserPrefsStorage userPrefsStorage = new JsonUserPrefsStorage(temporaryFolder.resolve("userPrefs.json"));
        StorageManager storage = new StorageManager(eduDexStorage, userPrefsStorage);
    ...
    private void assertCommandFailureForExceptionFromStorage(IOException e, String expectedMessage) {
        ...
        // Inject LogicManager with an EduDexStorage that throws the IOException e when saving
        JsonEduDexStorage eduDexStorage = new JsonEduDexStorage(prefPath) {
            @Override
            public void saveEduDex(ReadOnlyEduDex eduDex, Path filePath)
                    throws IOException {
                throw e;
            }
        };
        ...
        String addCommand = AddCommand.COMMAND_WORD + NAME_DESC_AMY + PHONE_DESC_AMY
                + SCHOOL_DESC_AMY + ADDRESS_DESC_AMY + SUBJECT_DESC_AMY;
