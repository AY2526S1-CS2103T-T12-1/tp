...
public class EditPersonDescriptorBuilder {
    ...
    /**
     * Sets the {School} of the {@code EditPersonDescriptor} that we are building.
     */
    public EditPersonDescriptorBuilder withSchool(String email) {
        descriptor.setSchool(new School(email));
        return this;
    }
