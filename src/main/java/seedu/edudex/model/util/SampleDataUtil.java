...
public class SampleDataUtil {
    public static Person[] getSamplePersons() {
        return new Person[] {
            new Person(new Name("Alex Yeoh"), new Phone("87438807"), new School("NUS"),
                    new Address("Blk 30 Geylang Street 29, #06-40"),
                    getTagSet(),
                    new Subject(new Day("Monday"), new Time("14:00"), new Time("16:00"))),

            new Person(new Name("Bernice Yu"), new Phone("99272758"), new School("Jurong Primary School"),
                new Address("Blk 30 Lorong 3 Serangoon Gardens, #07-18"),
                getTagSet(),
                new Subject(new Day("Tuesday"), new Time("10:00"), new Time("12:00"))),

            new Person(new Name("Charlotte Oliveiro"), new Phone("93210283"), new School("Queenstown Primary School"),
                new Address("Blk 11 Ang Mo Kio Street 74, #11-04"),
                getTagSet("WeakinXXTopic", "StronginXXTopic"),
                new Subject(new Day("Wednesday"), new Time("09:00"), new Time("11:00"))),

            new Person(new Name("David Li"), new Phone("91031282"), new School("Edgedale Primary School"),
                new Address("Blk 436 Serangoon Gardens Street 26, #16-43"),
                getTagSet(),
                new Subject(new Day("Thursday"), new Time("13:00"), new Time("15:00"))),

            new Person(new Name("Irfan Ibrahim"), new Phone("92492021"), new School("Raffles Primary School"),
                new Address("Blk 47 Tampines Street 20, #17-35"),
                getTagSet(),
                new Subject(new Day("Friday"), new Time("11:00"), new Time("13:00"))),

            new Person(new Name("Roy Balakrishnan"), new Phone("92624417"), new School("Nanyang Primary School"),
