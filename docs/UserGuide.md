...
**Tip:** You can delete multiple students if needed.
1. perform `find KEYWORD [MORE_KEYWORDS]` followed by `delete 1`.
2. the list remains filtered so you can delete more students matching the criteria if needed.
